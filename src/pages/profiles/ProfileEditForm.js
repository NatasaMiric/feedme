...
// https://github.com/Code-Institute-Solutions/moments/blob/703c2f453c98e61f9df91981f8df973640569afc/src/pages/profiles/ProfileEditForm.js
...
const ProfileEditForm = () => {
  ...
  const { name, info, image } = profileData;
        ...
        <Col className="py-2 p-0 p-md-2 text-center" md={7} lg={6}>
          <Container className={appStyles.Content}>
            <Form.Group>
              ...
              <div>
                <Form.Label
                  className={`${btnStyles.Button} ${btnStyles.Submit} btn my-auto`}
